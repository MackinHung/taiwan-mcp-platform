...
const TDX_API_BASE = 'https://tdx.transportdata.tw/api/basic/v2/Parking';
...
// Valid TDX city codes
export const VALID_CITIES = [
  'Taipei', 'NewTaipei', 'Taichung', 'Kaohsiung', 'Taoyuan',
] as const;

export type CityCode = typeof VALID_CITIES[number];

export function isValidCity(city: string): city is CityCode {
  return VALID_CITIES.includes(city as CityCode);
}
